			...
			<div class = "container-fluid">
				<div class = "navbar-header">
					<h1><p class = "navbar-text pull-right"><img src="allieslogo.jpg" alt=""></p></h1>
				</div>
		...
		<div id="sidebar" class="bg-dark">
			...
			<div id="sidebar-field">
				<a href="employee.php" class="sidebar-item">
						<div class="sidebar-icon"><i class="fa fa-columns"> </i></div>  Employee List
				</a>
			</div>
			<div id="sidebar-field">
				<a href="attendance.php" class="sidebar-item">
						<div class="sidebar-icon"><i class="fa fa-list"> </i></div>  Attendance Data
				</a>
			</div>
			<div id="sidebar-field">
